              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: Obx(
                    () => ListTile(
                      title: Text(
                        controller.guessedWord[reversedIndex].guess,
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.w500,
                          color:
                              controller.guessedWord[reversedIndex].isCorrect
                                  ? Colors.green
                                  : Colors.red,
                        ),
                      ),
                      subtitle: Text(
                        controller.guessedWord[reversedIndex].feedback,
                      ),
                      trailing: Text(
                        'Score: ${controller.guessedWord[reversedIndex].score}',
                      ),
                    ),
                  ),
                );
